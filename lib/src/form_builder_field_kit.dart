...
import 'package:flutter_form_builder_kit/src/extensions/autovalidatemode_extension.dart';

import 'flutter_builder_kit.dart';
...
class FormBuilderFieldKit<T> extends FormField<T> {
  ...
  @override
  FormBuilderFieldKitState<FormBuilderFieldKit<T>, T> createState() =>
      FormBuilderFieldKitState<FormBuilderFieldKit<T>, T>();
}

class FormBuilderFieldKitState<F extends FormBuilderFieldKit<T>, T>
    extends FormFieldState<T> {
  String? _customErrorText;
  FormBuilderKitState? _formBuilderState;
  bool _touched = false;
  bool _dirty = false;
  ...
  FormBuilderKitState? get formState => _formBuilderState;
  ...
  void initState() {
    ...
    _formBuilderState = FormBuilderKit.of(context);
  ...
  @override
  void didUpdateWidget(covariant FormBuilderFieldKit<T> oldWidget) {
  ...
  bool validate({
    ...
    final fields = _formBuilderState?.fields ??
        <String, FormBuilderFieldKitState<FormBuilderFieldKit<dynamic>, dynamic>>{};
