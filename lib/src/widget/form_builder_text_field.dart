...
import 'package:flutter_form_builder_kit/src/form_builder_field_decoration.dart';

/// A Material Design text field input.
class FormBuilderKitTextField extends FormBuilderFieldDecoration<String> {
  ...
  @override
  FormBuilderFieldDecorationState<FormBuilderKitTextField, String> createState() =>
      _FormBuilderTextFieldState();
}

class _FormBuilderTextFieldState
    extends FormBuilderFieldDecorationState<FormBuilderKitTextField, String> {
